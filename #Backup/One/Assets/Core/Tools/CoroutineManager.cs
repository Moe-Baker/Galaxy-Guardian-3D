...
namespace Game
{
    public class CoroutineManager
    {
        ...
        public Coroutine Yield(Action action, float delay)
        {
            return behaviour.StartCoroutine(YieldProcedure(action, delay));
        }
        IEnumerator YieldProcedure(Action action, float delay)
        {
